...
\restrict 5zOpzH9SJxDFkS7chzQeI51PvXrHoTAIPmc9cupOCzQ9mMQELlGCQORgVWBfrsQ
...
CREATE SEQUENCE public.catalog_crawl_jobs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.catalog_crawl_jobs_id_seq OWNED BY public.catalog_crawl_jobs.id;
...
CREATE TABLE public.catalog_crawl_log (
    id integer NOT NULL,
    make text NOT NULL,
...
CREATE SEQUENCE public.catalog_crawl_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.catalog_crawl_log_id_seq OWNED BY public.catalog_crawl_log.id;
...
CREATE TABLE public.catalog_crawl_unit_log (
    id integer NOT NULL,
    make text NOT NULL,
    model_code text NOT NULL,
...
CREATE SEQUENCE public.catalog_crawl_unit_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.catalog_crawl_unit_log_id_seq OWNED BY public.catalog_crawl_unit_log.id;
...
CREATE TABLE public.catalog_model_claim (
    id integer NOT NULL,
    make text NOT NULL,
...
CREATE SEQUENCE public.catalog_model_claim_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.catalog_model_claim_id_seq OWNED BY public.catalog_model_claim.id;
...
CREATE TABLE public.catalog_unit_retry (
    id integer NOT NULL,
    make text NOT NULL,
    model_key text NOT NULL,
    unit_key text NOT NULL,
...
CREATE SEQUENCE public.catalog_unit_retry_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.catalog_unit_retry_id_seq OWNED BY public.catalog_unit_retry.id;
...
CREATE TABLE public.catalog_worker_heartbeat (
...
ALTER TABLE ONLY public.catalog_crawl_jobs ALTER COLUMN id SET DEFAULT nextval('public.catalog_crawl_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.catalog_crawl_log ALTER COLUMN id SET DEFAULT nextval('public.catalog_crawl_log_id_seq'::regclass);
...
ALTER TABLE ONLY public.catalog_crawl_unit_log ALTER COLUMN id SET DEFAULT nextval('public.catalog_crawl_unit_log_id_seq'::regclass);
...
ALTER TABLE ONLY public.catalog_model_claim ALTER COLUMN id SET DEFAULT nextval('public.catalog_model_claim_id_seq'::regclass);
...
ALTER TABLE ONLY public.catalog_unit_retry ALTER COLUMN id SET DEFAULT nextval('public.catalog_unit_retry_id_seq'::regclass);
...
ALTER TABLE ONLY public.catalog_crawl_jobs
...
ALTER TABLE ONLY public.catalog_crawl_log
...
ALTER TABLE ONLY public.catalog_crawl_unit_log
...
ALTER TABLE ONLY public.catalog_model_claim
...
ALTER TABLE ONLY public.catalog_unit_retry
...
ALTER TABLE ONLY public.catalog_worker_heartbeat
...
CREATE INDEX idx_crawl_jobs_status ON public.catalog_crawl_jobs USING btree (status);
...
CREATE INDEX idx_crawl_log_model ON public.catalog_crawl_log USING btree (make, model_code);
...
CREATE INDEX idx_model_claim ON public.catalog_model_claim USING btree (make, model_key, status);
...
CREATE INDEX idx_model_claim_finished ON public.catalog_model_claim USING btree (finished_at);
...
CREATE INDEX idx_unit_log ON public.catalog_crawl_unit_log USING btree (make, model_code, unit_key);
...
CREATE INDEX idx_unit_log_scraped ON public.catalog_crawl_unit_log USING btree (scraped_at);
...
CREATE INDEX idx_unit_log_worker ON public.catalog_crawl_unit_log USING btree (worker_id, scraped_at);
...
CREATE INDEX idx_unit_retry ON public.catalog_unit_retry USING btree (make, model_key, unit_key);
...
CREATE UNIQUE INDEX uq_crawl_jobs_make_line ON public.catalog_crawl_jobs USING btree (make, COALESCE(model_line, ''::text));
...
\unrestrict 5zOpzH9SJxDFkS7chzQeI51PvXrHoTAIPmc9cupOCzQ9mMQELlGCQORgVWBfrsQ
